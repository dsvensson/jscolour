...
ALL : "$(OUTDIR)\jscolour.exe" "$(OUTDIR)\tyrlite.bsc"
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)\jscolour.pdb" /machine:I386 /out:"$(OUTDIR)\jscolour.exe" 
LINK32_OBJS= \
	"$(INTDIR)\bspfile.obj" \
	"$(INTDIR)\cmdlib.obj" \
	"$(INTDIR)\entities.obj" \
...
"$(OUTDIR)\jscolour.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "$(OUTDIR)\tyrlite.exe" "$(OUTDIR)\tyrlite.bsc"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\tyrlite.bsc"
	-@erase "$(OUTDIR)\tyrlite.exe"
	-@erase "$(OUTDIR)\tyrlite.ilk"
	-@erase "$(OUTDIR)\tyrlite.pdb"
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /pdb:"$(OUTDIR)\tyrlite.pdb" /debug /machine:I386 /out:"$(OUTDIR)\tyrlite.exe"\
 /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\bspfile.obj" \
	"$(INTDIR)\cmdlib.obj" \
...
"$(OUTDIR)\tyrlite.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<
